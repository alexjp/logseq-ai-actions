...
- [ ] **Changeset** — `.changeset/subtree-per-block.md` (minor bump 1.2.0 → 1.3.0) describing the feature; `pnpm changeset version` to apply.
- [ ] **Final gate** — `pnpm typecheck && pnpm lint && pnpm test` (expect ~94% statements / ~90% branches).
